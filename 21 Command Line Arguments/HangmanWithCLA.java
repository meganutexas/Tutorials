...
public class HangmanWithCLA {
    private static final int WRONG_GUESSES = 5;

    public static void main(String[] args) {
        if (args.length == 0) {
            throw new IllegalStateException(
                    "No answer given as a command line argument"
            );
        }
    ...
    public static void playHangman(String answer, String guess, Scanner scan) {
        ...
        String asterisksAdd = insertAsterisksForMissingLetters(answer, correctGuesses);
        ...
        while (countAskerisks(asterisksAdd) > 0 &&
            ...
            if (alreadyGuessed(guessTracker, guessChar)) {
                ...
                asterisksAdd = insertAsterisksForMissingLetters(answer, correctGuesses);
            }
        }
    ...
    public static String insertAsterisksForMissingLetters(String answer, String correctGuesses) {
