...
public class CaesarCipher {
    public static void main(String[] args) {
        System.out.println("AfTeR encoded: " + encode(3,
                "AfTeR"));
        System.out.println("xcQbO decoded: " + decode(3,
                "XcQbO"));
    }

    public static String encode(int shiftAmount,
                                String originalWord) {
        String encodedWord = "";
